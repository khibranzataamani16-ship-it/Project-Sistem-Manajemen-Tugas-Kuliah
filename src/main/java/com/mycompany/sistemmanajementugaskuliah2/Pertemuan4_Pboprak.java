package com.mycompany.sistemmanajementugaskuliah_2;

import java.util.ArrayList;
import java.util.Scanner;

public class SistemManajemenTugasKuliah_2 {
    ...
    public SistemManajemenTugasKuliah_2(String namaTugas, String mataKuliah, String deadline, String status) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<SistemManajemenTugasKuliah_2> daftarTugas = new ArrayList<>();
        ...
        do {
            ...
            if (pilihan == 1) {
                ...
                SistemManajemenTugasKuliah_2 tugas =
                        new SistemManajemenTugasKuliah_2(
                                namaTugas,
                                mataKuliah,
                                deadline,
                                status
        ...
        if (!daftarTugas.isEmpty()) {
            ...
            SistemManajemenTugasKuliah_2 tugas = daftarTugas.get(0);
